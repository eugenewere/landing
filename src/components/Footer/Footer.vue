<template>
  <footer class="p-4 sm:p-6 bg-neutral-950" id="contact">
...
<!--            <img src="@/assets/image/favicon/favicon-16.png" class="mr-3 h-8" alt="FlowBite Logo"/>-->
        ...
        <div class="grid grid-cols-7 gap-4 lg:w-[50%] ">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-neutral-500 sm:text-center dark:text-neutral-400">
          ...
          <a href="#" class="hover:underline">Kebu™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a href="#" class="text-neutral-500 hover:text-kebu-400 dark:hover:text-white">
