    ...
    <div class="mx-auto max-w-[1340px] px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-center lg:gap-16">
        <div class="w-full text-center lg:text-left">
          ...
          <p class="mt-4 max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
        ...
        >
          <div>
            ...
            <p class="text-2xl font-bold text-neutral-950 sm:text-3xl">
          ...
          <footer class="mt-4 text-sm font-medium text-kebu-400 sm:mt-6">
            &mdash; Michael Scott
          </footer>
        </blockquote>
        <blockquote
...
<style scoped>
.review_card {
  @apply border border-neutral-200 rounded-lg flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8 lg:p-12
}
</style>
